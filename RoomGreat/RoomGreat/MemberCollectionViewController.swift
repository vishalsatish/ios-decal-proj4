...
class MemberCollectionViewController: UICollectionViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        let secondTab = (self.tabBarController?.viewControllers![0] as! UINavigationController).topViewController as! GroupTableViewController
        if edit != nil {
            for (idx, group) in secondTab.groups.enumerate() {
                for (id, member) in group.members.enumerate() {
                    if member == edit!.0 && member != edit!.1 {
                        secondTab.groups[idx].members[id] = edit!.1
                    }
                }
            }
        }
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("MemberCollectionViewCell", forIndexPath: indexPath) as! MemberCollectionViewCell
    ...
    override func collectionView(collectionView: UICollectionView, shouldSelectItemAtIndexPath indexPath: NSIndexPath) -> Bool {
        let cell = collectionView.cellForItemAtIndexPath(indexPath) as! MemberCollectionViewCell
    ...
    */
    ...
    @IBAction func unwindToMemberCollectionViewController(sender: UIStoryboardSegue) {
